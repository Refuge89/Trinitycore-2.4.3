...
bool ExtractSingleModel(std::string& fname, std::string& name)
{
    name = GetPlainName((char*)fname.c_str());
    char* ext = GetExtension((char*)name.c_str());
...
void ExtractGameobjectModels()
{
    ...
    for (DBCFile::Iterator it = dbc.begin(); it != dbc.end(); ++it)
    {
        ...
        {
            std::string name;
            result = ExtractSingleModel(path, name);
        }
