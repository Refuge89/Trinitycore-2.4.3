...
enum MopyFlags
{
    WMO_MATERIAL_NOCAMCOLLIDE   = 0x01,
    WMO_MATERIAL_DETAIL         = 0x02,
    WMO_MATERIAL_COLLISION      = 0x04,
    WMO_MATERIAL_HINT           = 0x08,
    WMO_MATERIAL_RENDER         = 0x10,
    WMO_MATERIAL_COLLIDE_HIT    = 0x20,
