                    ...
                    while (uint32 eventId = events.ExecuteEvent())
                    {
                        switch (eventId)
                        {
                            case EVENT_CHECK_RESISTS:
                                DoCastSelf(SPELL_CHECK_RESISTS);
                            ...
                            case EVENT_BLIZZARD:
                                ...
                                events.ScheduleEvent(EVENT_BLIZZARD, Seconds(13), 0, PHASE_GROUND);
                                break;
                            case EVENT_FLIGHT:
                    ...
                    if (uint32 eventId = events.ExecuteEvent())
                    {
                        switch (eventId)
                        {
                            ...
                            case EVENT_LIFTOFF:
                            {
                                ...
                                SelectTargetList(targets, 5, SELECT_TARGET_RANDOM, 0, 200.0f, true);
