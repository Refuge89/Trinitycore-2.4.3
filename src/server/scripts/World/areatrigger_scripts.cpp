...
class AreaTrigger_at_brewfest : public AreaTriggerScript
{
    public:
        ...
        bool OnTrigger(Player* player, AreaTriggerEntry const* trigger) override
        {
            ...
            if (GameTime::GetGameTime() - triggerTimes[triggerId] < AREATRIGGER_TALK_COOLDOWN)
                return false;
            ...
            triggerTimes[triggerId] = GameTime::GetGameTime();
            return false;
        }
...
class AreaTrigger_at_area_52_entrance : public AreaTriggerScript
{
    public:
        ...
        {
            triggerTimes[AT_AREA_52_SOUTH] = triggerTimes[AT_AREA_52_NORTH] = triggerTimes[AT_AREA_52_WEST] = triggerTimes[AT_AREA_52_EAST] = 0;
        }
        ...
        bool OnTrigger(Player* player, AreaTriggerEntry const* trigger) override
        {
            ...
            uint32 triggerId = trigger->id;
            if (GameTime::GetGameTime() - triggerTimes[trigger->id] < SUMMON_COOLDOWN)
                return false;
            ...
            triggerTimes[trigger->id] = GameTime::GetGameTime();
            return false;
        }
    private:
        std::map<uint32, time_t> triggerTimes;
