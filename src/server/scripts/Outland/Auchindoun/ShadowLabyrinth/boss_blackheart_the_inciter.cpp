...
struct boss_blackheart_the_inciter : public BossAI
{
    ...
    void JustEngagedWith(Unit* who) override
    {
        ...
        events.ScheduleEvent(EVENT_INCITE_CHAOS, Seconds(20));
        events.ScheduleEvent(EVENT_CHARGE_ATTACK, Seconds(5));
        events.ScheduleEvent(EVENT_WAR_STOMP, Seconds(15));
        ...
        while (uint32 eventId = events.ExecuteEvent())
        {
            switch (eventId)
            {
                ...
                case EVENT_WAR_STOMP:
                    ...
                    events.Repeat(randtime(Seconds(18), Seconds(24)));
                    break;
            }
