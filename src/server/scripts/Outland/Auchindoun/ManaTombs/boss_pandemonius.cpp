    ...
    public:
        ...
        struct boss_pandemoniusAI : public BossAI
        {
            ...
            void JustEngagedWith(Unit* who) override
            {
                ...
                Talk(SAY_AGGRO);
                events.ScheduleEvent(EVENT_DARK_SHELL, Seconds(20));
                events.ScheduleEvent(EVENT_VOID_BLAST, randtime(Seconds(8), Seconds(23)));
                ...
                switch (eventId)
                {
                    case EVENT_VOID_BLAST:
                        ...
                        else
                        {
                            ...
                            events.RescheduleEvent(EVENT_DARK_SHELL, events.GetNextEventTime(EVENT_DARK_SHELL) + 500);
                        }
                        break;
