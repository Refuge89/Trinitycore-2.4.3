    ...
    public:
        ...
        struct boss_nexusprince_shaffarAI : public BossAI
        {
            ...
            void JustEngagedWith(Unit* who) override
            {
                ...
                events.ScheduleEvent(EVENT_BEACON, Seconds(10));
                events.ScheduleEvent(EVENT_FIREBALL, Seconds(8));
                events.ScheduleEvent(EVENT_FROSTBOLT, Seconds(4));
                events.ScheduleEvent(EVENT_FROST_NOVA, Seconds(15));

                std::list<Creature*> creatureList;
                me->GetCreatureListWithEntryInGrid(creatureList, 0, 100.0f);
                for (std::list<Creature*>::iterator itr = creatureList.begin(); itr != creatureList.end(); ++itr)
                        (*itr)->GetAI()->AttackStart(who);
            }
            ...
            void ExecuteEvent(uint32 eventId) override
            {
                switch (eventId)
                {
                    ...
                    case EVENT_FIREBALL:
                        ...
                        events.Repeat(randtime(Seconds(4), Seconds(6)));
                        break;
                    ...
                    case EVENT_FROST_NOVA:
                        ...
                        events.Repeat(randtime(Seconds(17), Seconds(25)));
                        events.ScheduleEvent(EVENT_BLINK, Milliseconds(1500));
                        break;
                    default:
                        break;
                }
    ...
    public:
        ...
        struct npc_ethereal_beaconAI : public ScriptedAI
        {
            ...
            void JustEngagedWith(Unit* who) override
            {
                ...
                events.ScheduleEvent(EVENT_APPRENTICE, DUNGEON_MODE(Seconds(20), Seconds(10)));
                events.ScheduleEvent(EVENT_ARCANE_BOLT, Seconds(1));
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_ARCANE_BOLT:
                            ...
                            events.Repeat(randtime(Seconds(2), Milliseconds(4500)));
                            break;
                        default:
                            break;
                    }
...
class npc_ethereal_apprentice : public CreatureScript
{
    public:
        ...
        struct npc_ethereal_apprenticeAI : public ScriptedAI
        {
            ...
            void JustEngagedWith(Unit* /*who*/) override
            {
                events.ScheduleEvent(EVENT_ETHEREAL_APPRENTICE_FIREBOLT, Seconds(3));
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_ETHEREAL_APPRENTICE_FIREBOLT:
                            ...
                            events.ScheduleEvent(EVENT_ETHEREAL_APPRENTICE_FROSTBOLT, Seconds(3));
                            break;
...
class npc_yor : public CreatureScript
{
    public:
        ...
        struct npc_yorAI : public ScriptedAI
        {
            ...
            void JustEngagedWith(Unit* /*who*/) override
            {
                events.ScheduleEvent(EVENT_DOUBLE_BREATH, randtime(Seconds(6), Seconds(9)));
            }
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                if (events.ExecuteEvent() == EVENT_DOUBLE_BREATH)
                {
                    if (me->IsWithinDist(me->GetVictim(), ATTACK_DISTANCE))
                        DoCastVictim(SPELL_DOUBLE_BREATH);
                    events.Repeat(randtime(Seconds(6), Seconds(9)));
                }
