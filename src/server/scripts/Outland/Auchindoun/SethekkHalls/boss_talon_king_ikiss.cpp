    ...
    public:
        ...
        struct boss_talon_king_ikissAI : public BossAI
        {
            ...
            void JustEngagedWith(Unit* who) override
            {
                ...
                Talk(SAY_AGGRO);
                events.ScheduleEvent(EVENT_ARCANE_VOLLEY, Seconds(5));
                events.ScheduleEvent(EVENT_POLYMORPH, Seconds(8));
                events.ScheduleEvent(EVENT_BLINK, Seconds(35));
                if (IsHeroic())
                    events.ScheduleEvent(EVENT_SLOW, randtime(Seconds(15), Seconds(30)));
            }
            ...
            void ExecuteEvent(uint32 eventId) override
            {
                switch (eventId)
                {
                    case EVENT_POLYMORPH:
                        ...
                        events.Repeat(randtime(Seconds(15), Seconds(17)));
                        break;
                    ...
                    case EVENT_SLOW:
                        ...
                        events.Repeat(randtime(Seconds(15), Seconds(40)));
                        break;
                    case EVENT_BLINK:
                        ...
                        events.Repeat(randtime(Seconds(35), Seconds(40)));
                        events.ScheduleEvent(EVENT_ARCANE_EXPLOSION, Seconds(1));
                        break;
