    ...
    public:
        ...
        struct boss_anzuAI : public BossAI
        {
            ...
            void JustEngagedWith(Unit* who) override
            {
                ...
                events.ScheduleEvent(EVENT_PARALYZING_SCREECH, Seconds(14));
                events.ScheduleEvent(EVENT_CYCLONE_OF_FEATHERS, Seconds(5));
            }
            ...
            void DamageTaken(Unit* /*killer*/, uint32 &damage) override
            {
                if (me->HealthBelowPctDamaged(33, damage) && !under33Percent)
                {
                    ...
                    events.ScheduleEvent(EVENT_SUMMON, Seconds(3));
                }
