...
{
    DungeonEncounter(DungeonEncounterEntry const* _dungeonEncounterEntry, EncounterCreditType _creditType, uint32 _creditEntry, uint32 _lastEncounterDungeon)
        : dungeonEncounterEntry(_dungeonEncounterEntry), creditType(_creditType), creditEntry(_creditEntry), lastEncounterDungeon(_lastEncounterDungeon) { }

    DungeonEncounterEntry const* dungeonEncounterEntry;
