...
class TC_GAME_API GameObjectAI
{
    ...
    public:
        ...
        virtual void SpellHitByUnit(Unit* /*caster*/, SpellInfo const* /*spellInfo*/) { }
        virtual void SpellHitByGo(GameObject* /*caster*/, SpellInfo const* /*spellInfo*/) { }

        // Called when spell hits a target
        virtual void SpellHitUnitTarget(Unit* /*target*/, SpellInfo const* /*spellInfo*/) { }
        virtual void SpellHitGoTarget(GameObject* /*target*/, SpellInfo const* /*spellInfo*/) { }
};
