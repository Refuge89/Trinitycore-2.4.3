        ...
        if (m_originalCaster)
        {
            ...
            if (m_spellAura)
            {
                ...
                else
                {
                    ...
                    // and duration of auras affected by SPELL_ATTR5_HASTE_AFFECT_DURATION
        ...
        switch (m_spellInfo->Effects[i].Effect)
        {
            ...
            case SPELL_EFFECT_CHARGE:
            {
                ...
                if (GetSpellInfo()->NeedsExplicitUnitTarget())
                {
                    ...
                    float range = m_spellInfo->GetMaxRange(m_caster, this) * 1.5f + objSize; // can't be overly strict
