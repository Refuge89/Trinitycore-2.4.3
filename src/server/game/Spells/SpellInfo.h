...
public:
    ...
    SpellEffectInfo() : _spellInfo(nullptr), _effIndex(0), Effect(0), ApplyAuraName(0), Amplitude(0), DieSides(0),
                        BaseDice(0), DicePointsPerLevel(0), RealPointsPerLevel(0), BasePoints(0), PointsPerComboPoint(0),
                        ValueMultiplier(0), DamageMultiplier(0), MiscValue(0), MiscValueB(0), Mechanic(MECHANIC_NONE),
                        RadiusEntry(nullptr), ChainTarget(0), ItemType(0), TriggerSpell(0), ImplicitTargetConditions(nullptr) {}
...
class TC_GAME_API SpellInfo
{
    ...
    public:
        ...
        float GetMaxRange(WorldObject* caster = nullptr, Spell* spell = nullptr) const;
