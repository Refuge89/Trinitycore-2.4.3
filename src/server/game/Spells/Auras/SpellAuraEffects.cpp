...
pAuraEffectHandler AuraEffectHandler[TOTAL_AURAS]=
{
    ...
    &AuraEffect::HandleNULL,                                      //145 SPELL_AURA_MOD_PET_TALENT_POINTS
    ...
    &AuraEffect::HandleNULL,                                      //249 SPELL_AURA_CONVERT_RUNE
    ...
    &AuraEffect::HandleNULL,                                      //256 SPELL_AURA_NO_REAGENT_USE Use SpellClassMask for spell select
    ...
    &AuraEffect::HandleUnused,                                    //262 SPELL_AURA_ABILITY_IGNORE_AURASTATE implemented in Spell::CheckCast
    &AuraEffect::HandleUnused,                                    //263 SPELL_AURA_ALLOW_ONLY_ABILITY player can use only abilities set in SpellClassMask
    &AuraEffect::HandleUnused,                                    //264 unused (3.2.0)
    &AuraEffect::HandleUnused,                                    //265 unused (3.2.0)
    &AuraEffect::HandleUnused,                                    //266 unused (3.2.0)
    &AuraEffect::HandleUnused,                                    //267 SPELL_AURA_MOD_IMMUNE_AURA_APPLY_SCHOOL         implemented in Unit::IsImmunedToSpellEffect
    &AuraEffect::HandleUnused,                                    //268 SPELL_AURA_MOD_ATTACK_POWER_OF_STAT_PERCENT
    &AuraEffect::HandleUnused,                                    //269 SPELL_AURA_MOD_IGNORE_TARGET_RESIST implemented in Unit::CalcAbsorbResist and CalcArmorReducedDamage
    &AuraEffect::HandleUnused,                                    //270 SPELL_AURA_MOD_ABILITY_IGNORE_TARGET_RESIST implemented in Unit::CalcAbsorbResist and CalcArmorReducedDamage
    &AuraEffect::HandleUnused,                                    //271 SPELL_AURA_MOD_DAMAGE_FROM_CASTER    implemented in Unit::SpellDamageBonus
    &AuraEffect::HandleUnused,                                    //272 SPELL_AURA_IGNORE_MELEE_RESET
    &AuraEffect::HandleUnused,                                    //273 clientside
    &AuraEffect::HandleUnused,                                    //274 SPELL_AURA_CONSUME_NO_AMMO implemented in spell::CalculateDamageDoneForAllTargets
    &AuraEffect::HandleUnused,                                    //275 SPELL_AURA_MOD_IGNORE_SHAPESHIFT Use SpellClassMask for spell select
    &AuraEffect::HandleUnused,                                    //276 mod damage % mechanic?
    &AuraEffect::HandleUnused,                                    //277 SPELL_AURA_MOD_ABILITY_AFFECTED_TARGETS implemented in spell::settargetmap
    &AuraEffect::HandleUnused,                                    //278 SPELL_AURA_MOD_DISARM_RANGED disarm ranged weapon
    &AuraEffect::HandleUnused,                                    //279 SPELL_AURA_INITIALIZE_IMAGES
    &AuraEffect::HandleUnused,                                    //280 SPELL_AURA_MOD_TARGET_ARMOR_PCT
    &AuraEffect::HandleUnused,                                    //281 SPELL_AURA_MOD_HONOR_GAIN_PCT implemented in Player::RewardHonor
    &AuraEffect::HandleUnused,                                    //282 SPELL_AURA_MOD_BASE_HEALTH_PCT
    &AuraEffect::HandleUnused,                                    //283 SPELL_AURA_MOD_HEALING_RECEIVED       implemented in Unit::SpellHealingBonus
    &AuraEffect::HandleUnused,                                    //284 SPELL_AURA_LINKED
    &AuraEffect::HandleUnused,                                    //285 SPELL_AURA_MOD_ATTACK_POWER_OF_ARMOR  implemented in AuraEffect::PeriodicTick and Player::UpdateAttackPowerAndDamage
    &AuraEffect::HandleUnused,                                    //286 SPELL_AURA_ABILITY_PERIODIC_CRIT implemented in AuraEffect::PeriodicTick
    &AuraEffect::HandleUnused,                                    //287 SPELL_AURA_DEFLECT_SPELLS             implemented in Unit::MagicSpellHitResult and Unit::MeleeSpellHitResult
    &AuraEffect::HandleUnused,                                    //288 SPELL_AURA_IGNORE_HIT_DIRECTION  implemented in Unit::MagicSpellHitResult and Unit::MeleeSpellHitResult Unit::RollMeleeOutcomeAgainst
    &AuraEffect::HandleUnused,                                    //289 SPELL_AURA_PREVENT_DURABILITY_LOSS implemented in Player::DurabilityPointsLoss
    &AuraEffect::HandleUnused,                                    //290 SPELL_AURA_MOD_CRIT_PCT
    &AuraEffect::HandleUnused,                                    //291 SPELL_AURA_MOD_XP_QUEST_PCT  implemented in Player::RewardQuest
    &AuraEffect::HandleUnused,                                    //292 SPELL_AURA_OPEN_STABLE
    &AuraEffect::HandleUnused,                                    //293 SPELL_AURA_OVERRIDE_SPELLS auras which probably add set of abilities to their target based on it's miscvalue
    &AuraEffect::HandleUnused,                                    //294 SPELL_AURA_PREVENT_REGENERATE_POWER implemented in Player::Regenerate(Powers power)
    &AuraEffect::HandleUnused,                                    //295 0 spells in 3.3.5
    &AuraEffect::HandleUnused,                                    //297 Spirit Burst spells
    &AuraEffect::HandleUnused,                                    //298 70569 - Strangulating, maybe prevents talk or cast
    &AuraEffect::HandleUnused,                                    //299 unused
    &AuraEffect::HandleUnused,                                    //300 SPELL_AURA_SHARE_DAMAGE_PCT implemented in Unit::DealDamage
    &AuraEffect::HandleUnused,                                    //301 SPELL_AURA_SCHOOL_HEAL_ABSORB implemented in Unit::CalcHealAbsorb
    &AuraEffect::HandleUnused,                                    //302 0 spells in 3.3.5
    &AuraEffect::HandleUnused,                                    //303 SPELL_AURA_MOD_DAMAGE_DONE_VERSUS_AURASTATE implemented in Unit::SpellDamageBonus, Unit::MeleeDamageBonus
    &AuraEffect::HandleUnused,                                    //304 SPELL_AURA_MOD_DRUNK
    &AuraEffect::HandleUnused,                                    //305 SPELL_AURA_MOD_MINIMUM_SPEED
    &AuraEffect::HandleUnused,                                    //306 0 spells in 3.3.5
    &AuraEffect::HandleUnused,                                    //307 0 spells in 3.3.5
    &AuraEffect::HandleUnused,                                    //308 SPELL_AURA_MOD_CRIT_CHANCE_FOR_CASTER implemented in Unit::GetUnitCriticalChance and Unit::GetUnitSpellCriticalChance
    &AuraEffect::HandleUnused,                                    //309 0 spells in 3.3.5
    &AuraEffect::HandleUnused,                                    //310 SPELL_AURA_MOD_CREATURE_AOE_DAMAGE_AVOIDANCE implemented in Spell::CalculateDamageDone
    &AuraEffect::HandleUnused,                                    //311 0 spells in 3.3.5
    &AuraEffect::HandleUnused,                                    //312 0 spells in 3.3.5
    &AuraEffect::HandleUnused,                                    //313 0 spells in 3.3.5
    &AuraEffect::HandleUnused,                                    //314 SPELL_AURA_PREVENT_RESURRECTION todo
    &AuraEffect::HandleUnused,                                    //315 SPELL_AURA_UNDERWATER_WALKING todo
    &AuraEffect::HandleUnused,                                    //316 SPELL_AURA_PERIODIC_HASTE implemented in AuraEffect::CalculatePeriodic
};
...
void AuraEffect::CalculatePeriodic(Unit* caster, bool resetPeriodicTimer /*= true*/, bool load /*= false*/)
{
    ...
    if (_amplitude)
    {
        ...
        if (caster)
        {
            ...
            // and periodic time of auras affected by SPELL_ATTR5_HASTE_AFFECT_DURATION
...
void AuraEffect::HandleAuraModShapeshift(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    {
        // Dash
        if (AuraEffect* aurEff = target->GetAuraEffectOfRankedSpell(1850, 0))
            aurEff->RecalculateAmount();
...
void AuraEffect::HandleFeignDeath(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    {
        /*
        WorldPacket data(SMSG_FEIGN_DEATH_RESISTED, 8 + 1);
        data << target->GetGUID();
        data << uint8(0);
...
void AuraEffect::HandlePeriodicDamageAurasTick(Unit* target, Unit* caster) const
{
    ...
    SpellPeriodicAuraLogInfo pInfo(this, damage, overkill, absorb, resist, 0.0f, false);
...
void AuraEffect::HandlePeriodicHealthLeechAuraTick(Unit* target, Unit* caster) const
{
    ...
    if (caster)
        caster->SendSpellNonMeleeDamageLog(target, GetId(), damage, GetSpellInfo()->GetSchoolMask(), absorb, resist, false, 0, false);
    damage = damageInfo.GetDamage();
...
void AuraEffect::HandlePeriodicHealAurasTick(Unit* target, Unit* caster) const
{
    ...
    SpellPeriodicAuraLogInfo pInfo(this, heal, heal - healInfo.GetEffectiveHeal(), healInfo.GetAbsorb(), 0, 0.0f, false);
    target->SendPeriodicAuraLog(&pInfo);
