...
class TC_GAME_API GameObject : public WorldObject, public GridObject<GameObject>, public MapObject
{
    public:
        ...
        uint8 GetGoArtKit() const { return GetInt32Value(GAMEOBJECT_ARTKIT); }
        void SetGoArtKit(uint8 artkit);
        uint8 GetGoAnimProgress() const { return GetInt32Value(GAMEOBJECT_ANIMPROGRESS); }
        void SetGoAnimProgress(uint8 animprogress) { SetInt32Value(GAMEOBJECT_ANIMPROGRESS, animprogress); }
        ...
        void ModifyHealth(int32 change, WorldObject* attackerOrHealer = nullptr);
