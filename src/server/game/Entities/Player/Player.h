...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void SendInstanceResetWarning(uint32 mapid, uint32 time, bool welcome) const;
        ...
        InventoryResult CanTakeMoreSimilarItems(uint32 entry, uint32 count) const { return CanTakeMoreSimilarItems(entry, count, nullptr, nullptr); }
        ...
        static bool ValidateAppearance(uint8 race, uint8 gender, uint8 hairID, uint8 hairColor, uint8 faceID, uint8 facialHair, uint8 skinColor, bool create = false);
        ...
        // only changed for direct client control (possess, etc.), not stuff you control using pet commands
        ...
        bool IsLfgAutoJoin() const { return LfgAutoJoin; }
        void SetLfgAutoJoin(bool autoJoin) { LfgAutoJoin = autoJoin; }
