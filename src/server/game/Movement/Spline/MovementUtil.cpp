...
namespace Movement
{
    ...
    char const* g_MovementFlag_names[] =
    {
        ...
        STR(Flying_P           ), // 0x02000000,               // Actual Flying Mode
    ...
    char const* g_SplineFlag_names[32] =
    {
        ...
        STR(Unknown20    ), // 0x00080000,
        STR(Cyclic       ), // 0x00100000,
        STR(Enter_Cycle  ), // 0x00200000,
        STR(Frozen       ), // 0x00400000,
        STR(Unknown24    ), // 0x00800000,
        STR(Unknown25    ), // 0x01000000,
        STR(Unknown26    ), // 0x02000000,
        STR(Unknown27    ), // 0x04000000,
        STR(Unknown28    ), // 0x08000000,
        STR(Unknown29    ), // 0x10000000,
        STR(Unknown30    ), // 0x20000000,
        STR(Unknown31    ), // 0x40000000,
        STR(Unknown32    )  // 0x80000000,
    };
